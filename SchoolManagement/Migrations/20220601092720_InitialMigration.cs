        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_dbo.Enrollment_dbo.Students_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_dbo.CourseSubjects_dbo.Course_Id",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_dbo.CourseSubjects_dbo.Subjects_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_dbo.LecturerSubjects_dbo.Lecturer_Id",
                        column: x => x.LecturerId,
                        principalTable: "Lecturer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_dbo.LecturerSubjects_dbo.Subject_Id",
                        column: x => x.SubjectId,
                        principalTable: "Subject",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_dbo.FinalScore_dbo.Enrollment_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_dbo.Grades_dbo.Enrollment_Id",
                        column: x => x.EnrollmentId,
                        principalTable: "Enrollment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinalScore_EnrollmentId",
                table: "FinalScore",
                column: "EnrollmentId");
